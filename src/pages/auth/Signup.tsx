...
import { z } from "zod";
import { Film, UserPlus, EyeOff, Eye } from "lucide-react";
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mt-10">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              ...
              <Link to="/auth/login" className="text-movie-accent hover:underline">
                Sign in here
              </Link>
            </p>
          </div>
                    ...
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="text-sm font-normal">
                          I accept the{" "}
                          <Link to="/terms" className="text-movie-accent hover:underline">
                            Terms of Service
                          </Link>
                          {" "}and{" "}
                          <Link to="/privacy" className="text-movie-accent hover:underline">
                            Privacy Policy
                          </Link>
                        </FormLabel>
                        <FormMessage />
      ...
      <div className="hidden lg:block relative w-0 flex-1 bg-gradient-to-br from-movie-dark to-movie-accent/20">
        <div className="absolute inset-0 bg-black/40 backdrop-blur-sm flex flex-col items-center justify-center p-12">
          <div className="max-w-2xl text-center">
            <h2 className="text-4xl font-bold mb-6">Join Movie Pulse</h2>
            <p className="text-xl mb-8">Create your account to build personal watchlists, get personalized recommendations, and join our community of movie lovers.</p>
